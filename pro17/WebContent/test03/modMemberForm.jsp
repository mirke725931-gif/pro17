    ...
    <table align="center">
      <tr>
        ...
        <tr>
          ...
          <td width="400">
            <p><input type="text" name="name" value="${memInfo.name}"></p>
          </td>
        </tr>
        <tr>
          <td width="200">
          ...
          <td width="400">
            <p><input type="text" name="email" value="${memInfo.email}">
          </td>
        </tr>
        <tr>
          <td width="200">
          ...
          <td width="400">
            <p><input type="text" name="joinDate" value="${memInfo.joinDate}" disabled>
          </td>
        </tr>
        <tr align="center">
